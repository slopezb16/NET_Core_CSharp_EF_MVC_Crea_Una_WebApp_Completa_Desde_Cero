...
namespace Turnos.Controllers
{
    public class MedicoController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var medico = await _context.Medico.Where(x => x.IdMedico == id)
            .Include(z => z.MedicoEspecialidad).ThenInclude(e => e.Especialidad).FirstOrDefaultAsync();
            if (medico == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var medico = await _context.Medico.Where(x => x.IdMedico == id)
                                                .Include(z => z.MedicoEspecialidad).FirstOrDefaultAsync();
            ...
            if (medico.MedicoEspecialidad.Count == 0)
            {
        ...
        {
            var medicoHorarioDesde = _context.Medico.Where(x => x.IdMedico == idMedico).FirstOrDefault().HorarioAtencionDesde;

            return medicoHorarioDesde.Hour + ":" + medicoHorarioDesde.Minute;
        }

        public string TraerHorarioAtencionHasta(int idMedico)
        {
            var medicoHorarioHasta = _context.Medico.Where(x => x.IdMedico == idMedico).FirstOrDefault().HorarioAtencionHasta;

            return medicoHorarioHasta.Hour + ":" + medicoHorarioHasta.Minute;
        }
    }
}
